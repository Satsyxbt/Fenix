...
async function main() {
  ...
  await logTx(
    ...
    FeesVaultFactoryUpgradeable.changeCreatorForFeesVaults(DeployedContracts[AliasDeployedContracts.PairFactoryUpgradeable_Proxy], [
  ...
  await logTx(
    FeesVaultFactoryUpgradeable,
    FeesVaultFactoryUpgradeable.changeCreatorForFeesVaults(DeployedContracts[AliasDeployedContracts.AlgebraFactory_Proxy], [
