...
async function main() {
  ...
  console.log('22_update_voter_to_new_impl -- started');

  await deployBase('VoterUpgradeableV1_2', 'VoterUpgradeableV1_2Implementation', [deployer.address]);
  ...
  console.log('22_update_voter_to_new_impl -- finished');
}
