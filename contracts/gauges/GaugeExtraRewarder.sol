...
contract GaugeExtraRewarder is BlastGovernorSetup, Ownable {
    ...
    constructor(address governor_, IERC20 _rewardToken, address gauge) {
    ...
    function onReward(address _user, address to, uint256 userBalance) external onlyGauge {
