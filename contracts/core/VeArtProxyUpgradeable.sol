                ...
                Base64.encode(
                    bytes(
                        string.concat(
                            ...
                            Base64.encode(bytes(_generateSVG(tokenId_, balanceOf_, lockedEnd_))),
                            '"}'
                        )
                    )
                )
