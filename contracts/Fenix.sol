 ...
 */
contract Fenix is IFenix, ERC20, ERC20Burnable, Ownable {
    /**
     ...
     */
    constructor(address emissionManager_)
        ERC20("Fenix", "FNX")
        Ownable()
    {
     ...
     */
    function mint(address to_, uint256 amount_) external override virtual onlyOwner {
        _mint(to_, amount_);
    }
}